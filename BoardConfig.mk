...
DEVICE_PATH := device/oukitel/k10000
...
TARGET_GLOBAL_CFLAGS += $(MTK_INTERNAL_CDEFS)
TARGET_GLOBAL_CPPFLAGS += $(MTK_INTERNAL_CDEFS)
...
TARGET_INIT_VENDOR_LIB := libinit_k10000
